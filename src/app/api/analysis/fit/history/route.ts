...
import { buildDummyFitHistory } from "../dummyFitAnalysis"

// hcr-backend 서버·DB 폐쇄로 실제 조회 대신 고정 mock 목록을 반환한다.
...
export async function GET() {
  return NextResponse.json({ success: true, data: buildDummyFitHistory() })
}
